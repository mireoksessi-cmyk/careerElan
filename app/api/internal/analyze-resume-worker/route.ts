...
/*
  ...
  for local end-to-end testing - the local dev server process itself never
  gets torn down after sending a response, unlike a real serverless
  invocation, so a dangling await here still runs to completion in
  practice).
