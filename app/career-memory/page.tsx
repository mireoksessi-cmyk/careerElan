...
export default function CareerMemoryPage() {
  ...
  function updateMemory(field: keyof CareerMemoryData, value: string) {
  ...
  function renderStepForm() {
    if (currentStep === 0) {
      return (
        <div className="mt-6 grid gap-5 md:grid-cols-2">
          <input type="text" placeholder="First Name" value={memoryData.firstName} onChange={(e) => updateMemory("firstName", e.target.value)} className="rounded-xl border border-gray-300 px-4 py-3 outline-none focus:border-blue-600" />
          <input type="text" placeholder="Last Name" value={memoryData.lastName} onChange={(e) => updateMemory("lastName", e.target.value)} className="rounded-xl border border-gray-300 px-4 py-3 outline-none focus:border-blue-600" />
          <input type="email" placeholder="Email" value={memoryData.email} onChange={(e) => updateMemory("email", e.target.value)} className="rounded-xl border border-gray-300 px-4 py-3 outline-none focus:border-blue-600" />
          <input type="text" placeholder="Phone" value={memoryData.phone} onChange={(e) => updateMemory("phone", e.target.value)} className="rounded-xl border border-gray-300 px-4 py-3 outline-none focus:border-blue-600" />
          <input type="text" placeholder="Location" value={memoryData.location} onChange={(e) => updateMemory("location", e.target.value)} className="rounded-xl border border-gray-300 px-4 py-3 outline-none focus:border-blue-600" />
          <input type="text" placeholder="LinkedIn" value={memoryData.linkedin} onChange={(e) => updateMemory("linkedin", e.target.value)} className="rounded-xl border border-gray-300 px-4 py-3 outline-none focus:border-blue-600" />
          <input type="text" placeholder="Professional Headline" value={memoryData.headline} onChange={(e) => updateMemory("headline", e.target.value)} className="rounded-xl border border-gray-300 px-4 py-3 outline-none focus:border-blue-600 md:col-span-2" />
    ...
    if (currentStep === 1) {
      return (
        <div className="mt-6 space-y-5">
          ...
          <button onClick={() => addItem("education", emptyEducation)} className="rounded-xl border border-blue-600 px-5 py-3 font-bold text-blue-600">
            + Add Education
          </button>
        </div>
      );
    ...
    if (currentStep === 2) {
      return (
        <div className="mt-6 space-y-5">
          ...
          <button onClick={() => addItem("workExperience", emptyWork)} className="rounded-xl border border-blue-600 px-5 py-3 font-bold text-blue-600">
            + Add Work Experience
          </button>
        </div>
      );
    ...
    if (currentStep === 3) {
      return (
        <div className="mt-6 space-y-5">
          ...
          <button onClick={() => addItem("volunteerExperience", emptyVolunteer)} className="rounded-xl border border-blue-600 px-5 py-3 font-bold text-blue-600">
    ...
    if (currentStep === 5) {
      return (
        <div className="mt-6 space-y-5">
          ...
          <button onClick={() => addItem("languages", emptyLanguage)} className="rounded-xl border border-blue-600 px-5 py-3 font-bold text-blue-600">
            + Add Language
          </button>
        </div>
      );
    ...
    if (currentStep === 6) {
      return (
        <div className="mt-6 space-y-5">
          ...
          <button onClick={() => addItem("certifications", emptyCertification)} className="rounded-xl border border-blue-600 px-5 py-3 font-bold text-blue-600">
            + Add Certification
          </button>
        </div>
      );
    ...
    if (currentStep === 7) {
      return (
        <div className="mt-6 space-y-5">
          ...
          <button onClick={() => addItem("projects", emptyProject)} className="rounded-xl border border-blue-600 px-5 py-3 font-bold text-blue-600">
            + Add Project
          </button>
        </div>
      );
    ...
    return (
      <div className="mt-6 grid gap-5 md:grid-cols-2">
        <input type="text" placeholder="Target Roles" value={memoryData.targetRoles} onChange={(e) => updateMemory("targetRoles", e.target.value)} className="rounded-xl border border-gray-300 px-4 py-3 outline-none focus:border-blue-600" />
        <input type="text" placeholder="Target Industry" value={memoryData.targetIndustry} onChange={(e) => updateMemory("targetIndustry", e.target.value)} className="rounded-xl border border-gray-300 px-4 py-3 outline-none focus:border-blue-600" />
        <input type="text" placeholder="Preferred Location" value={memoryData.targetLocation} onChange={(e) => updateMemory("targetLocation", e.target.value)} className="rounded-xl border border-gray-300 px-4 py-3 outline-none focus:border-blue-600" />
        <input type="text" placeholder="Salary Expectation" value={memoryData.salaryExpectation} onChange={(e) => updateMemory("salaryExpectation", e.target.value)} className="rounded-xl border border-gray-300 px-4 py-3 outline-none focus:border-blue-600" />
        ...
        <section className="flex-1 px-8 py-6">
          ...
          {mode === "start" && (
            <div className="grid gap-6 md:grid-cols-2">
              <button onClick={() => setMode("import")} className="rounded-2xl border border-blue-100 bg-white p-10 text-left shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
                ...
                <p className="mt-4 text-sm leading-6 text-gray-500">Upload your PDF or DOCX resume. Career Élan will extract your experience, education, skills, and certifications automatically.</p>
              ...
              <button onClick={() => setMode("build")} className="rounded-2xl border border-blue-100 bg-white p-10 text-left shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
                ...
                <p className="mt-4 text-sm leading-6 text-gray-500">Create your career profile step by step with AI guidance and bullet point suggestions.</p>
          ...
          {mode === "import" && (
            <div className="rounded-2xl border border-blue-100 bg-white p-10 shadow-sm">
              ...
              <p className="mt-3 text-gray-500">Upload your existing resume to auto-fill your Career Memory.</p>
              <div className="mt-8 rounded-2xl border-2 border-dashed border-blue-200 bg-blue-50 p-16 text-center">
                ...
                <button className="mt-6 rounded-xl bg-blue-600 px-6 py-3 font-bold text-white">Browse Files</button>
              </div>
            </div>
          )}
