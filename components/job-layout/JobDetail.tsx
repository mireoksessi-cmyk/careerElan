      ...
      <div className="flex items-start justify-between">
        ...
        <div>
          ...
          <p className="mt-2 text-sm text-gray-400">
            ...
            📍 {selectedApplication.location || "Location unavailable"}
...
<div className="flex flex-wrap gap-3">
  ...
  <button
    onClick={() =>
      window.open(selectedApplication.job_url, "_blank")
    }
...
{selectedTab === "resume" && (
  <A4Preview
    text={selectedApplication.resume_text || ""}
  />
)}

{selectedTab === "cover" && (
  <A4Preview
    text={selectedApplication.cover_letter_text || ""}
  />
)}

{selectedTab === "email" && (
  <div className="rounded-2xl border border-gray-200 bg-white p-8 whitespace-pre-wrap shadow-sm">
