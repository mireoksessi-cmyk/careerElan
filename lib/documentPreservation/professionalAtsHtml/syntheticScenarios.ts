    ...
    education: [
      block(
        ...
        "education-entry",
        {
          ...
          credentials: [tv("Bachelor of Commerce", "synthetic-all-edu")],
          fieldsOfStudy: [],
          institutions: [tv("Dalhousie University", "synthetic-all-edu")],
          honors: [],
          details: [],
    ...
    certifications_licenses: [
      block(
        ...
        "credential-entry",
        {
          ...
          names: [tv("Project Management Professional (PMP)", "synthetic-all-cred")],
          issuers: [tv("PMI", "synthetic-all-cred")],
          details: [],
          kind: "certification",
    ...
    projects: [
      block(
        ...
        "project-entry",
        {
          ...
          descriptionParagraphs: [],
          content: [{ id: "synthetic-all-proj-content-0", kind: "bullet", text: "Reduced fulfillment errors by 30%.", source: trace("synthetic-all-proj") }],
    ...
    awards: [
      block(
        ...
        "award-entry",
        {
          ...
          names: [tv("Operational Excellence Award", "synthetic-all-award")],
          details: [],
          content: [],
    ...
    publications: [
      block(
        ...
        "publication-entry",
        {
          ...
          titles: [tv("Lean Practices in Regional Logistics", "synthetic-all-pub")],
          authors: [],
          details: [],
          content: [],
    ...
    additional_information: [
      block(
        ...
        "custom-section",
        {
          ...
          bullets: [],
          content: [{ id: "synthetic-all-custom-content-0", kind: "paragraph", text: "English (native), French (professional working proficiency).", source: trace("synthetic-all-custom") }],
          sourceOrder: 0,
...
export function customSectionOnly(): ProfessionalAtsAssemblyDocument {
  const custom: CustomResumeSection = {
    ...
    content: [
      { id: "synthetic-custom-only-content-0", kind: "bullet", text: "Long-distance cycling.", source: trace("synthetic-custom-only") },
      { id: "synthetic-custom-only-content-1", kind: "bullet", text: "Amateur astronomy.", source: trace("synthetic-custom-only") },
    ],
    sourceOrder: 0,
