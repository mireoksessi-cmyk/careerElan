...
function main() {
  ...
  const withEducation = minimalResume({
    education: [
      { id: "edu-1", institution: "", credential: "", fieldOfStudy: "", institutions: ["Central College"], credentials: ["Bachelor of Arts"], fieldsOfStudy: ["History", "Political Science"], dateRangeText: "2010 - 2014", gpa: "", honors: ["Dean's List"], details: [], rawHeaderText: "" },
    ],
  });
